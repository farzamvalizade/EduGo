...
const Navbar = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 flex flex-row-reverse justify-around items-center w-full h-16 bg-secondary-light border-t border-white/5 text-white z-50 px-2">
      ...
      <Link to="/subjects" className="flex items-center gap-4 px-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
      ...
      <Link to="/progress" className="flex items-center gap-4 px-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
      ...
      <Link to="/profile" className="flex items-center gap-4 px-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
